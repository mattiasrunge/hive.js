...
suite("rstate", function()
{
  ...
  {
    var valid = [ "R1A01", "R1A99", "R1AA01", "R1AA99", "R1ZZ01", "R1ZZ99", "R99A01", "R99A99", "R99AA01", "R99AA99", "R99ZZ01", "R99ZZ99", "R1A", "R1A_2", "R1A02_3" ];
  ...
  suite("sort", function()
  {
    var list = [ "R1J07", "R1J06", "R1J02", "R1J08", "R1A02", "R1A02_3" ];
    
    test("Sorting of list", function()
    {
      assert.deepEqual(_rstate.sort(list), [ "R1A02", "R1A02_3", "R1J02", "R1J06", "R1J07", "R1J08" ]);
    });
  });
